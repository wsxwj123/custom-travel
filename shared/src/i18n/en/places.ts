...
const places: TranslationStrings = {
  ...
  'places.importSocialList': '小红书 / B站',
  'places.socialListHint': 'Paste a 小红书 or Bilibili link (or the note text below) — places are extracted automatically and matched on the map.',
  'places.socialTextPlaceholder': 'Or paste the note/transcript text here…',
  'places.socialImported': '{count} places imported from "{list}"',
  'places.socialUnmatched': 'Not matched on the map: {names}',
  'places.socialError': 'Failed to import from social link',
