...
const places: TranslationStrings = {
  ...
  'places.socialListHint': '粘贴小红书或 B站链接（也可在下方直接粘贴笔记文字），自动提取地点并匹配到地图。',
  'places.socialTextPlaceholder': '或在此粘贴笔记 / 攻略全文…',
  'places.socialImported': '已从"{list}"导入 {count} 个地点',
  'places.socialUnmatched': '未能在地图上匹配：{names}',
  'places.socialError': '社交链接导入失败',
